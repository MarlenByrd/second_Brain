...
- `setup_light_models.sh <profile> status` — check readiness.
- `setup_light_models.sh <profile> prune` — remove non-profile qwen models.
- `services/ai-pipeline/agent_router.py` — task->model routing contract for small specialized agents.
